...
class LVLMForConditionalGeneration(LVLMPreTrainedModel):
    ...
    def generate(self, input_ids, attention_mask, image, image3d, **generation_config):
        ...
        llm_outputs = self.llm.generate(**llm_inputs, **generation_config, return_dict_in_generate=True, output_scores=True)
        return llm_outputs.sequences, llm_outputs.scores
